  ...
  return (
    <div className="md:m-20 my-15  mx-12 py-10 text-center text-3xl py-10">
      <div className="bg-zinc-200 md:mx-70 my-10 rounded-4xl md:h-100 text-center hover: hover:shadow-zinc-400 shadow-2xl duration-300 ">
        ...
        <input className="text-xl md:w-90 border rounded" placeholder={placeholder} />
        <input
          className="md:m-10 mt-5 mb-10 text-xl md:w-90 border rounded"
          type="password"
          placeholder=" Password"
        />
        <br />

        <div className="md:text-2xl text-xl" onClick={handleClick}>
