...
const FAQs = () => {
  {
    ...
    return (
      <div
        className=" h-[50vh] md:w-full md:w-[60vh] mt-25 flex-1 justify-center text-center text-xl hover:shadow-zinc-100 duration-400 items-center bg-center bg-cover relative"
      >
