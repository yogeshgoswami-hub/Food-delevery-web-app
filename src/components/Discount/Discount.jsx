  ...
  render() {
    return (
      <section className="bg-zinc-100 bg-no-repeat bg-right bg-contain " style={{backgroundImage: `url(${freshfruit})`}}>
        <div className="md:bg-transparent bg-zinc-100 flex md:flex-row flex-col max-w-[1400px] mx-auto px-10 py-10 active:shadow-zinc-400 active:shadow-2xl duration-200 hover:shadow-lg shadow-zinc-400 transform transition duration-300   " >
